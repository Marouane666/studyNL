...
import { GOLD, GOLD_TEXT, NAVY, NAVY_DEEP, PageIntro, Panel } from "../ui";
  ...
  return (
    <>
      ...
      >
        ...
        <Link
          href="/forum"
          className="mt-6 inline-flex min-h-11 items-center rounded-2xl px-5 text-xs font-extrabold shadow-[0_10px_22px_rgba(201,164,92,0.3)] transition-opacity hover:opacity-90"
